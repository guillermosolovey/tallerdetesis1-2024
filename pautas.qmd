...
Las consultas se realizan escribiendo en el foro del campus. Pueden consultar el cronograma de asistencia por grupo [acá](cronograma.html).
...
Las entregas se cargan en en el campus de la materia y deben enviarse en PDF, sin código adjunto y con el nombre: <span style="color:#1776de;">G#-E$-APELLIDO-NOMBRE.PDF</span> donde \# es el número de grupo y \$ el número de la entrega

Pueden consultar el cronograma de entregas [acá](cronograma.html). 

## Uso de datos
Pueden encontrar pautas generales para la elección del dataset en [este documento](https://docs.google.com/document/d/1HzllxEjlBR44Yx5O97CJ_TH-aYdLH-J0Yb4awlfebXQ/edit?usp=drive_link). En general, pueden utilizar:

- **Datos públicos**: 
    sugerimos la utilización de uno de los datasets provistos en la [siguiente lista](https://docs.google.com/document/d/1HzllxEjlBR44Yx5O97CJ_TH-aYdLH-J0Yb4awlfebXQ/edit?usp=drive_link). Si el dataset es muy popular y ya hay en internet muchos trabajos hechos, se deberá reportar cómo el trabajo a realizar difiere de ellos. 
...
- [IC-datasets-docencia](https://daniellaparada.github.io/IC-datasets-docencia/)
